import dataObject from './getWeather.js'
 ...
 function getFetch() {
   return dataObject.getWeather(JSON.parse(localStorage.getItem('currentPos')))
...
function getLocationOnClick(e) {
    navigator.geolocation.getCurrentPosition(
      function (position) {
        localStorage.setItem('currentPos', JSON.stringify({latitude:position.coords.latitude, longitude:position.coords.longitude}))
